...
pub trait IRandomProvider<TContractState> {
    fn rand(ref self: TContractState, amount: u256) -> felt252;
...
mod RandomProvider {
    ...
    use core_v0::reservoir::{IReservoirDispatcher, IReservoirDispatcherTrait};
    ...
    impl RandomProviderImpl of super::IRandomProvider<ContractState> {
        fn rand(ref self: ContractState, amount: u256) -> felt252 {
